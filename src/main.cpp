...
int main() {
  ...
  // start in lane 1 (i.e., lane 0 is the left-most lane for cars going our direction)
  int lane = 1;
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // either we will reference the starting point as where the car is or at the previous path's endpoint
            double ref_x = car_x;
            double ref_y = car_y;
